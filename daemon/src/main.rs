...
async fn run() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let transition_pipeline = if let Some(format) = swapchain_format {
        ...
        let frag_modules: Vec<(TransitionKind, _)> = [
            ...
            (TransitionKind::Radial, "transition_radial.frag"),
            (TransitionKind::Pinwheel, "transition_pinwheel.frag"),
            (TransitionKind::Morph, "transition_morph.frag"),
            (TransitionKind::Wind, "transition_wind.frag"),
            (TransitionKind::Ripple, "transition_ripple.frag"),
            (TransitionKind::WaterDrop, "transition_water_drop.frag"),
            (TransitionKind::Squeeze, "transition_squeeze.frag"),
            (TransitionKind::Doorway, "transition_doorway.frag"),
            (TransitionKind::Hexagonalize, "transition_hexagonalize.frag"),
            (TransitionKind::Kaleidoscope, "transition_kaleidoscope.frag"),
            (TransitionKind::BookFlip, "transition_book_flip.frag"),
            (TransitionKind::Doom, "transition_doom.frag"),
            (TransitionKind::Rolls, "transition_rolls.frag"),
            (TransitionKind::Bounce, "transition_bounce.frag"),
            (TransitionKind::PolkaDots, "transition_polka_dots.frag"),
            (TransitionKind::Cube, "transition_cube.frag"),
            (TransitionKind::Swap, "transition_swap.frag"),
            (TransitionKind::CrossZoom, "transition_cross_zoom.frag"),
            (TransitionKind::FilmBurn, "transition_film_burn.frag"),
            (TransitionKind::GridFlip, "transition_grid_flip.frag"),
