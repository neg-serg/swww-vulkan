...
impl From<TransitionTypeArg> for swww_vulkan_common::ipc_types::TransitionType {
    fn from(arg: TransitionTypeArg) -> Self {
        match arg {
            ...
            TransitionTypeArg::WindowBlinds => Self::WindowBlinds,
            TransitionTypeArg::Radial => Self::Radial,
            TransitionTypeArg::Pinwheel => Self::Pinwheel,
            TransitionTypeArg::Morph => Self::Morph,
            TransitionTypeArg::Wind => Self::Wind,
            TransitionTypeArg::Ripple => Self::Ripple,
            TransitionTypeArg::WaterDrop => Self::WaterDrop,
            TransitionTypeArg::Squeeze => Self::Squeeze,
            TransitionTypeArg::Doorway => Self::Doorway,
            TransitionTypeArg::Hexagonalize => Self::Hexagonalize,
            TransitionTypeArg::Kaleidoscope => Self::Kaleidoscope,
            TransitionTypeArg::BookFlip => Self::BookFlip,
            TransitionTypeArg::Doom => Self::Doom,
            TransitionTypeArg::Rolls => Self::Rolls,
            TransitionTypeArg::Bounce => Self::Bounce,
            TransitionTypeArg::PolkaDots => Self::PolkaDots,
            TransitionTypeArg::Cube => Self::Cube,
            TransitionTypeArg::Swap => Self::Swap,
            TransitionTypeArg::CrossZoom => Self::CrossZoom,
            TransitionTypeArg::FilmBurn => Self::FilmBurn,
            TransitionTypeArg::GridFlip => Self::GridFlip,
